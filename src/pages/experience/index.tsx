    ...
    <MantineTimeline.Item
      ...
      <Grid gutter="xl" grow>
          ...
          <List.Item>
            ...
            • developed guardrails in identity management system for regional commercial bank
            </Text>
          </List.Item>
          <List.Item>
            <Text color="dimmed" size="sm">
            • maintained sailPoint integration progress tracker
            </Text>
          </List.Item>
        </List>
